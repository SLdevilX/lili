...
from lili import CMD_LIST, LOAD_PLUG, MONGO_DB_URI, tbot, telethn, ubot
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"lili/advanced/{shortname}.py")
        name = "lili.advanced.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["lili.advanced." + shortname] = mod
        print("Successfully imported " + shortname)


path = "lili/advanced/*.py"

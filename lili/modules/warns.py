...
from lili import TIGERS, WOLVES, dispatcher
from lili.modules.disable import DisableAbleCommandHandler
from lili.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from lili.modules.helper_funcs.string_handling import split_quotes
from lili.modules.log_channel import loggable
from lili.modules.sql import warns_sql as sql

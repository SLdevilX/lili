...
import lili.modules.sql.global_bans_sql as sql
from lili import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from lili.modules.helper_funcs.misc import send_to_list
from lili.modules.sql.users_sql import get_user_com_chats

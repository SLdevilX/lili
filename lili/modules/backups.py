...
# from lili.modules.sql import warns_sql as warnssql
import lili.modules.sql.blacklist_sql as blacklistsql

# from lili.modules.sql import cust_filters_sql as filtersql
# import lili.modules.sql.welcome_sql as welcsql
import lili.modules.sql.locks_sql as locksql
import lili.modules.sql.notes_sql as sql

# from lili.modules.rules import get_rules
import lili.modules.sql.rules_sql as rulessql
from lili import JOIN_LOGGER, LOGGER, OWNER_ID, dispatcher
from lili.__main__ import DATA_IMPORT
from lili.modules.connection import connected
from lili.modules.helper_funcs.alternate import typing_action
from lili.modules.helper_funcs.chat_status import user_admin
from lili.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    f = open("lili{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("lili{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `lili-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("lili{}.backup".format(chat_id))  # Cleaning file

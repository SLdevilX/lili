...
from lili.modules.helper_funcs.chat_status import dev_plus, sudo_plus, whitelist_plus
from lili.modules.helper_funcs.extraction import extract_user
from lili.modules.log_channel import gloggable

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "lili/elevated_users.json")
...
def devlist(update: Update, context: CallbackContext):
    ...
    reply = "<b>Rental Association Members ⚡️:</b>\n"
...
DEVLIST_HANDLER = CommandHandler(["devlist", "renters"], devlist)
